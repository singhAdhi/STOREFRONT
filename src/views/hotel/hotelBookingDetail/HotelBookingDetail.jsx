              ...
              <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-md-6">
                  ...
                  {errors.inputEmail && touched.inputEmail ? (
                    <p className="text-danger">{errors.inputEmail}</p>
                  ) : null}
                </div>
                <div class="col-md-12">
                          ...
                          <div className="bg-lightgray">
                            <div className="row">
                              <div className="col-12">
                                ...
                                <p className="heading-xxs-light">{address}</p>
                              </div>
                            </div>
                            ...
                            <div className="row align-items-center">
                              ...
                              <div className="col-6 offset-3 offset-sm-0 col-sm-3 col-lg-3 d-flex align-items-center flex-lg-column text-lg-center mb-3 mb-sm-0 px-lg-1">
                              ...
                              <div className="col-6 col-sm-3 col-lg-3 d-flex align-items-center flex-lg-column text-lg-center pl-lg-1">
                                <img src="time.png" alt="" />
                                <div className="ml-2 ml-lg-0 mt-lg-1">
                                  <p className="heading-xxs-regular">
                                    Check-out
                            ...
                            <div className="row">
                              <div className="col-12 text-right">
                                <p className="heading-sm-medium">
                                  Total Points {actualdata.TotalPoints}
                                </p>
                              </div>
                            </div>
                          </div>
